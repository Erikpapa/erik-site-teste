  ...
  return (
    <section className="relative pt-12 pb-20 sm:pt-16 sm:pb-28 overflow-hidden bg-gradient-to-b from-[#FFF9F0] via-[#FFF9F0] to-[#F1E6D7]/40 border-b border-[#F1E6D7]">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        {/* Image directly below the headline */}
        <div className="my-8 sm:my-10 relative max-w-2xl mx-auto">
          ...
          <div className="relative bg-white rounded-2xl overflow-hidden shadow-xl border-4 border-white">
            <img
              src={`${import.meta.env.BASE_URL}images/hero-vereda-pagina.webp`}
            ...
            <div className="absolute bottom-3 left-3 right-3 sm:bottom-4 sm:left-4 sm:right-4 bg-white/95 backdrop-blur-xs p-3 sm:p-4 rounded-xl border border-[#F1E6D7] shadow-sm flex items-center justify-between text-left">
        ...
        <div className="pt-8 space-y-3">
          ...
          <div className="flex flex-wrap items-center justify-center gap-y-1 gap-x-4 text-xs text-[#596561]">
